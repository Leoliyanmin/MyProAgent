from layers.database.repositories import ScheduleRepository
from layers.business.schedule_logic import ScheduleBusinessLogic


class ScheduleService:
    def __init__(self):
        self.schedule_repo = ScheduleRepository()
        self.schedule_logic = ScheduleBusinessLogic()
