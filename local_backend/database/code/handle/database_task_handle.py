...
class TaskHandle:
    ...
    def create_task(self, user_id: str, title: str, description: str = None, due_date: str = None) -> dict:
        """创建任务入口"""
        # 验证输入
    ...
    def update_task(self, user_id: str, task_id: int, title: str = None, description: str = None, due_date: str = None) -> dict:
        """更新任务入口"""
        # 验证输入
        if not task_id:
    ...
    def delete_task(self, user_id: str, task_id: int) -> dict:
        ...
        try:
            self.operations.delete_task(user_id, task_id)
