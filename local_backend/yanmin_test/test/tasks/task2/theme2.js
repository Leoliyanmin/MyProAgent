...
export const DEFAULTS = {
  accent:      '#DC143C',      // 深红色主题色
  bgApp:       '#2C1A1A',      // 深红色背景
  bgAppImage:  '',
  bgSidebar:   '#3A2424',      // 稍浅的深红色侧边栏
  bgTopbar:    '#3A2424',      // 稍浅的深红色顶部栏
  bgContent:   '#2C1A1A',      // 深红色内容区
  bgAgent:     '#3A2424',      // 稍浅的深红色代理区
  bgSidebarImage: '',
  bgTopbarImage: '',
  bgContentImage: '',
  bgAgentImage: '',
  bgCard:      '#3A2424',      // 深红色卡片背景
  textPrimary: '#F5E6E6',      // 浅色主文字
  textMuted:   '#D4B8B8',      // 稍暗的浅色次要文字
  borderColor: '#5C3A3A',      // 深红色边框
  cardRadius:  12,
}
