...
# 直接修改 database_command 模块的路径（必须在 import 前）
import builtins
_server_db_path = str(db_file)
...
def init_database():
    ...
    try:
        ...
        db_cmd.DEFAULT_DB_PATH = _server_db_path
        init_one(_server_db_path)
